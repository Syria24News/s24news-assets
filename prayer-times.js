...
(function () {
  ...
  var PAGE_CSS = [
    ...
    '.s24pt-table td:first-child,.s24pt-table th:first-child{text-align:right;white-space:nowrap;position:sticky;right:0;background:var(--bg-card,#fff)}',
    '.s24pt-table thead th{position:sticky;top:0;background-color:var(--bg-card,#fff);background-image:linear-gradient(rgba(119,189,29,.14),rgba(119,189,29,.14));z-index:2}',
    '.s24pt-table thead th:first-child{top:0;z-index:3;background-color:var(--bg-card,#fff);background-image:linear-gradient(rgba(119,189,29,.14),rgba(119,189,29,.14))}',
