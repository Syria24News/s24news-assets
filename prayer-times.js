...
(function () {
  ...
  var PAGE_CSS = [
    ...
    '.s24pt-table thead th{position:sticky;top:var(--sticky-top-offset,140px);background:var(--bg-card,#fff);z-index:2}',
    '.s24pt-table thead th:first-child{top:var(--sticky-top-offset,140px);z-index:3}',
